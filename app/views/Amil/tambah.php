<!-- Breadcome start-->
      ...
      <form action="<?= BASEURL; ?>/Amil/aksi_tambah" method="POST">
              ...
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <input type="text" class="form-control" name="nama_amil" required="">
                      </div>
                  </div>
              </div>
          </div>
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <select name='id_mesjid' class="form-control" required="">
                            ...
                            ?>
                            <option value="<?=$pnr['id_mesjid'];?>"><?= $pnr['nama_mesjid'];?> </option>
                            <?php endforeach ?>
                          </select>
                      </div>
                  </div>
