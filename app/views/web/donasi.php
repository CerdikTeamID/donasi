				...
				<div class="progress-table-wrap">
					<div class="progress-table">
						<div class="table-head">
							...
							<div class="country">Donatur</div>
                            <div class="percentage">No Telepon</div>
							<div class="percentage">Jumlah Donasi</div>
						</div>
						<?php 
						$no=1;
						foreach ($data['pnr'] as $dt) : ?>
						<div class="table-row">
							<div class="serial"><?= $no++;?></div>
							<div class="country"><?= $dt['tgl_donasi'];?></div>
                            <div class="country"><?= $dt['nama_donatur'];?></div>
							<div class="percentage"><?= $dt['no_hp_donatur'];?></div>  
                            <div class="percentage">Rp. <?= number_format($dt['total_donasi']);?> 
							</div>
