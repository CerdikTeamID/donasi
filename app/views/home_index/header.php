            ...
            <nav id="sidebar">
                ...
                <div class="left-custom-menu-adp-wrap">
                    <ul class="nav navbar-nav left-sidebar-menu-pro">
                        ...
                        <li class="nav-item">
                            <a href="<?=BASEURL;?>/Pembayaran/pembayaran"><i class="fa big-icon fa-clipboard"></i> <span class="mini-dn">Transaksi</span> <span class="indicator-right-menu mini-dn"></span></a>
                        </li>
                        ...
                        <li class="nav-item">
                            <a href="<?=BASEURL;?>/Penerimaan"><i class="fa big-icon fa-clipboard"></i> <span class="mini-dn">Penyaluran Donasi</span> <span class="indicator-right-menu mini-dn"></span></a>
                        </li>
                        ...
                        <li class="nav-item"><a href="#" data-toggle="dropdown" role="button" aria-expanded="false" class="nav-link dropdown-toggle"><i class="fa big-icon fa-print"></i> <span class="mini-dn">Laporan</span> <span class="indicator-right-menu mini-dn"><i class="fa indicator-mn fa-angle-left"></i></span></a>
                            <div role="menu" class="dropdown-menu left-menu-dropdown animated flipInX">
                                <a href="<?=BASEURL;?>/Report/Pembayar" class="dropdown-item" target="blank">Data Donatur</a>
                                <a href="<?=BASEURL;?>/Report/Zakat" class="dropdown-item" target="blank">Data Keuangan Donasi</a>
