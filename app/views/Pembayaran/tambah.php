        ...
        <h3><center>Data Pembayar</center></h3>
          ...
          <div class="form-group-inner">
              <div class="row">
                  ...
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <input type="number" name="jumlah_tanggungan" class="form-control" placeholder="Jumlah anggota keluarga yang dibayarkan">
                      </div>
                  </div>
              </div>
          </div>
          ...
          <div class="form-group-inner">
              <div class="row">
                  <div class="col-lg-3">
                      <label class="login2 pull-right pull-right-pro">Jenis Pembayaran</label>
                  </div>
                  <div class="col-lg-9">
                      <div class="form-select-list">
                          <select name="pembayaran_beras" class="form-control">
                            <option value="0">--Pilih Jenis--</option>
                            <option value="2.5">Pembayaran Beras</option>
                            <option value="50000">Pembayaran Uang</option>
                          </select>
                      </div>
                  </div>
              </div>
          ...
          <div class="form-group-inner">
              <div class="row">
                  <div class="col-lg-3">
                      <label class="login2 pull-right pull-right-pro">Jumlah Pembayaran</label>
                  </div>
                  <div class="col-lg-9">
                      <div class="form-select-list">
          ...
          <script type="text/javascript">
                function hitungtotal() {
                    var jumlah_tanggungan = document.getElementsByName('jumlah_tanggungan')[0].value;
                    var jenis_pembayaran = document.getElementsByName('pembayaran_beras')[0].value;

                    if (jumlah_tanggungan && jenis_pembayaran) {
                        var total_pembayaran = jumlah_tanggungan * jenis_pembayaran;
                        document.getElementsByName('pembayaran_uang')[0].value = total_pembayaran;
                        }
                    }

                    document.getElementsByName('jumlah_tanggungan')[0].addEventListener('input', hitungtotal);
                    document.getElementsByName('pembayaran_beras')[0].addEventListener('change', hitungtotal);
            </script>          
          <!-- <script>
            function startcalc(){
            ...
            function calc(){
                jumlah = document.autoSumForm.tanggungan.value;
                jenis = document.autoSumForm.pembayaran_beras.value;

                document.autoSumForm.pembayaran_uang.value = (jumlah * jenis);
                }
            function stopcalc(){
