            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 ">
               ...
               <option value="<?=$pnr['jenis_zakat'];?>"><?= $pnr['jenis_zakat'];?> </option>
                       ...
                       <div class="item form-group">
                        <label for="middle-name" class="col-form-label col-md-3 col-sm-3 label-align">Jenis Pembayaran</label>
                        <div class="col-md-6 col-sm-6 ">
                      ...
                      function hitungtotal() {
                        var jumlah_tanggungan = document.getElementsByName('tanggungan')[0].value;
                        ...
                        document.getElementsByName('tanggungan')[0].addEventListener('input', hitungtotal);
